 ...
 \
         ...
         */\
         ...
         for(int i = 1; i <= 5; i++)\{\
             ...
             \
         \}\
         System.out.println(ecount + " valor(es) par(es)");\
         System.out.println(ocount + " valor(es) impar(es)");\
         System.out.println(pcount + " valor(es) positivo(s)");\
         System.out.println(ncount + " valor(es) negativo(s)");\
         sc.close();\
 \
    \}\
 \
